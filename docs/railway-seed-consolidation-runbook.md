...
| Service | ID | Type |
|---|---|---|
| threatatlas (ais-relay) | `a5f66d97-217f-44a0-a42d-5f3b67752223` | AIS relay + inline seeds |
...
The simplest approach: use Railway's "shared variables" or copy all env vars from the `threatatlas` (ais-relay) service, which has a superset of all API keys.
