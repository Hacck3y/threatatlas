...
description: "ThreatAtlas platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
ThreatAtlas runs five specialized variants from a single codebase, each optimized for different monitoring needs.

## Platform Variants

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 ThreatAtlas** | [threatatlas.app](https://threatatlas.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.threatatlas.app](https://tech.threatatlas.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
| **😊 Happy Monitor** | [happy.threatatlas.app](https://happy.threatatlas.app) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.threatatlas.app](https://finance.threatatlas.app) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.threatatlas.app](https://commodity.threatatlas.app) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
...
The tech variant ([tech.threatatlas.app](https://tech.threatatlas.app)) provides specialized layers for technology sector monitoring.
...
The finance variant ([finance.threatatlas.app](https://finance.threatatlas.app)) provides specialized layers for global financial markets and economic intelligence.
...
| **Stock Analysis** | AI-powered stock analysis with backtesting |
...
The commodity variant ([commodity.threatatlas.app](https://commodity.threatatlas.app)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.threatatlas.app](https://happy.threatatlas.app)) curates positive news, human progress data, and uplifting stories.
