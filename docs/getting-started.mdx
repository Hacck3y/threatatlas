...
description: "Installation instructions, tech stack overview, project structure, API dependencies, and setup guide for ThreatAtlas."
---
This guide covers everything you need to set up ThreatAtlas locally, from prerequisites and installation to understanding the project structure and API dependencies.
...
// App.ts
const header = `ThreatAtlas v${__APP_VERSION__}`;
```
...
ThreatAtlas is licensed under the [GNU Affero General Public License v3.0 (AGPL-3.0)](/license) for non-commercial use. Commercial use requires a [separate license](/license#commercial-use-requires-a-separate-license). See the [License](/license) page for full details on what this means in practice.
