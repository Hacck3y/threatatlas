...
ThreatAtlas runs five thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **ThreatAtlas** | threatatlas.app | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor** | tech.threatatlas.app | AI/ML, startups, cybersecurity, tech ecosystems |
| **Finance Monitor** | finance.threatatlas.app | Markets, central banks, Gulf FDI, commodities |
| **Commodity Monitor** | commodity.threatatlas.app | Mining, metals, energy, critical minerals |
| **Happy Monitor** | happy.threatatlas.app | Good news, conservation, positive global trends |

### AI Intelligence Layer

ThreatAtlas uses a multi-tier AI pipeline to process and summarize information:
...
ThreatAtlas aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
ThreatAtlas serves several audiences:
...
| Feature | ThreatAtlas | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
- **Web**: Available at threatatlas.app and variant subdomains
...
ThreatAtlas is actively developed with planned expansions across several areas:

### Advanced Workflows (Planned)

- **Shared dashboards** with saved views and annotations
- **Scheduled AI briefings** delivered via email, Slack, Telegram, Discord, or WhatsApp
- **Expanded equity research** with financials, analyst targets, valuation metrics, and backtesting
- **Custom alert rules** for specific countries, topics, or threshold triggers
- **Developer access** for organizations that want to integrate ThreatAtlas data into their own tools
...
**Q: Is ThreatAtlas free?**
A: Yes. The core dashboard with all map layers, news feeds, live streams, and AI features is free to use today.

**Q: Where does ThreatAtlas get its data?**
...
**Q: Does ThreatAtlas track users or sell data?**
...
A: Yes. ThreatAtlas is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: ThreatAtlas was created by Elie Habib. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed ThreatAtlas or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, an API tier is planned. Please attribute "ThreatAtlas (threatatlas.app)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. ThreatAtlas aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: ThreatAtlas is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/hacck3y/threatatlas
- **Website**: threatatlas.app

---

*This document was last updated March 2026. ThreatAtlas is an independent, open-source project licensed under AGPL-3.0.*
