---
title: "Rate Limits"
description: "Per-endpoint, per-key, and per-IP rate limits across the ThreatAtlas API surface."
---
...
Other write endpoints (`/api/brief/share-url`, `/api/notification-channels`, and similar mutation routes) fall back to the default per-IP limit above.
