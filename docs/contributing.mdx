---
title: "Contributing"
description: "Code style guidelines, pull request process, contribution types, and security practices for the ThreatAtlas project."
---
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/threatatlas.git
   cd threatatlas
   ```
...
By contributing to ThreatAtlas, you agree that your contributions are licensed under AGPL-3.0. See the [License](/license) page for full terms, commercial licensing, and common scenarios.
