...
const VARIANT_HOST_MAP: Record<string, string> = {
  'tech.threatatlas.app': 'tech',
  'finance.threatatlas.app': 'finance',
  'commodity.threatatlas.app': 'commodity',
  'happy.threatatlas.app': 'happy',
};
...
const VARIANT_OG: Record<string, { title: string; description: string; image: string; url: string }> = {
  tech: {
    ...
    image: 'https://tech.threatatlas.app/favico/tech/og-image.png',
    url: 'https://tech.threatatlas.app/',
  },
  finance: {
    title: 'Finance Monitor - Real-Time Markets & Trading Dashboard',
    description: 'Real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    image: 'https://finance.threatatlas.app/favico/finance/og-image.png',
    url: 'https://finance.threatatlas.app/',
  },
  commodity: {
    ...
    image: 'https://commodity.threatatlas.app/favico/commodity/og-image.png',
    url: 'https://commodity.threatatlas.app/',
  },
  happy: {
    ...
    image: 'https://happy.threatatlas.app/favico/happy/og-image.png',
    url: 'https://happy.threatatlas.app/',
  },
};
