...
1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/hacck3y/threatatlas/security/advisories/new) to submit your report directly through the repository.
