...
const { searchGoogleFlights } = await import('../server/threatatlas/aviation/v1/search-google-flights.ts');
const { searchGoogleDates } = await import('../server/threatatlas/aviation/v1/search-google-dates.ts');
