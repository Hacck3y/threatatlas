...
import { adaptSnapshot } from '../server/threatatlas/intelligence/v1/get-regional-snapshot';

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = resolve(__dirname, '..');

const handlerSrc = readFileSync(
  resolve(root, 'server/threatatlas/intelligence/v1/get-regional-snapshot.ts'),
  'utf-8',
);
