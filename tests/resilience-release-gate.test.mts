...
import { getResilienceScore } from '../server/threatatlas/resilience/v1/get-resilience-score.ts';
import { scoreAllDimensions } from '../server/threatatlas/resilience/v1/_dimension-scorers.ts';
...
describe('resilience release gate', () => {
  ...
  // upgrade).
  //
  // The origin review claimed: "Norway and the US both hit 100 under current fixtures, which
