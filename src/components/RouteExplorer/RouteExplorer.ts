...
import type { GetRouteExplorerLaneResponse, GetRouteImpactResponse, BypassCorridorOption } from '@/generated/server/threatatlas/supply_chain/v1/service_server';
  ...
  private renderFreeGate(): void {
    ...
    if (this.contentEl) {
      this.contentEl.innerHTML =
        ...
        '<button class="re-content__upgrade" type="button">Retry</button>' +
        '</div>';
