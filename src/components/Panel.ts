...
const PANEL_COLLAPSED_KEY = 'threatatlas-panel-collapsed';
...
export class Panel {
  ...
  public showLocked(features: string[] = []): void {
    ...
    const ctaBtn = h('button', { type: 'button', className: 'panel-locked-cta' }, 'Retry');
    ctaBtn.addEventListener('click', () => window.location.reload());
