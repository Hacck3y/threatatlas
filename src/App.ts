...
// Removed: import { showProBanner } from '@/components/ProBanner'; // Pro banner removed
...
export class App {
  ...
  constructor(containerId: string) {
    ...
    const storedVariant = localStorage.getItem('threatatlas-variant');
    ...
    if (storedVariant !== currentVariant) {
      ...
      localStorage.setItem('threatatlas-variant', currentVariant);
      ...
      const PANEL_KEY_RENAMES_MIGRATION_KEY = 'threatatlas-panel-key-renames-v2.6.8';
      ...
      const UNIFIED_MIGRATION_KEY = 'threatatlas-unified-panels-v1';
      ...
      const HAPPY_PANEL_FIX_KEY = 'threatatlas-happy-panel-fix-v1';
      ...
      const PANEL_ORDER_MIGRATION_KEY = 'threatatlas-panel-order-v1.9';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'threatatlas-tech-insights-top-v1';
    ...
    const PANEL_PRUNE_KEY = 'threatatlas-panel-prune-v1';
    ...
    const LAYOUT_RESET_MIGRATION_KEY = 'threatatlas-layout-reset-v2.5';
    ...
    if (currentVariant === 'full') {
      const baseKey = 'threatatlas-sources-reduction-v3';
      ...
      const localeKey = `threatatlas-locale-boost-${userLang}`;
  ...
  public async init(): Promise<void> {
    ...
    if (!this.state.isMobile) {
      ...
      // this.state.breakingBanner = removed
    }
  ...
  public destroy(): void {
    ...
    this.unsubAiFlow?.();
    this.unsubFreeTier?.();
    // this.state.breakingBanner?.destroy(); // Removed
