...
const SETTINGS_KEY_PREFIXES: readonly string[] = [
  ...
  'threatatlas-live-channels',
  'threatatlas-active-channel',
  'threatatlas-runtime-feature-toggles',
  'wm-globe-render-scale',
  'wm-live-streams-always-on',
  'threatatlas-webcam-prefs',
  'wm-map-theme:',
  'map-height',
  'map-pinned',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('threatatlas-variant') || 'full',
    data,
  };
  ...
  a.download = `threatatlas-settings-${ts}.json`;
