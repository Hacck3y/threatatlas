...
export const STORAGE_KEYS = {
  panels: 'threatatlas-panels',
  monitors: 'threatatlas-monitors',
  mapLayers: 'threatatlas-layers',
  disabledFeeds: 'threatatlas-disabled-feeds',
  liveChannels: 'threatatlas-live-channels',
  mapMode: 'threatatlas-map-mode',          // 'flat' | 'globe'
  activeChannel: 'threatatlas-active-channel',
  webcamPrefs: 'threatatlas-webcam-prefs',
} as const;
