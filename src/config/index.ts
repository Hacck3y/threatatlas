...
// VITE_VARIANT=tech → tech.threatatlas.app (tech-focused)
// VITE_VARIANT=full → threatatlas.app (geopolitical)
// VITE_VARIANT=finance → finance.threatatlas.app (markets/trading)
