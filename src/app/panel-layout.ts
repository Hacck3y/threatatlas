...
export class PanelLayoutManager implements AppModule {
  ...
  private updatePanelGating(_state?: unknown): void {
  ...
  private async fetchGitHubStars(): Promise<void> {
    try {
      const response = await fetch('https://api.github.com/repos/hacck3y/threatatlas');
  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://threatatlas.app')}"
            ...
            <a href="${vHref('tech', 'https://tech.threatatlas.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.threatatlas.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://commodity.threatatlas.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://happy.threatatlas.app')}"
          ...
          <span class="logo">ThreatAtlas</span><span class="logo-mobile">ThreatAtlas</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://github.com/hacck3y/threatatlas" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">ThreatAtlas</span>
  ...
  private createPanels(): void {
    ...
    widgetBlock.className = 'add-panel-block ai-widget-block ai-widget-block-pro';
    ...
    widgetBlock.appendChild(widgetIcon);
    widgetBlock.appendChild(widgetLabel);
