...
function renderOverview(area: HTMLElement): void {
  ...
  area.innerHTML = `
    ...
    <div class="settings-ov-license">
      ...
      <section class="wm-section">
        <h2 class="wm-section-title">Open Configuration</h2>
        <p class="wm-section-desc">ThreatAtlas runs fully unlocked. Add your own API key above if you want the hosted relay, or keep using local providers and desktop integrations.</p>
        <div class="wm-register-row">
          <span class="wm-badge ok">All features available</span>
        </div>
      </section>
    </div>
  `;
