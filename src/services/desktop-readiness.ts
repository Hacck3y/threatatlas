...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/threatatlas/conflict/v1/handler.ts', 'server/threatatlas/infrastructure/v1/handler.ts', 'server/threatatlas/cyber/v1/handler.ts', 'server/threatatlas/maritime/v1/handler.ts', 'server/threatatlas/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/threatatlas/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/threatatlas/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/threatatlas/military/v1/handler.ts'],
    locality: 'api-key',
