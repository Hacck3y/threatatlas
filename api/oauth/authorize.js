...
<body><a href="https://www.threatatlas.app" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">WorldMonitor MCP</span></a>
<div class="card"><h1>${escapeHtml(title)}</h1><p>${escapeHtml(detail)}</p><a href="javascript:history.back()" class="back">&#8592; go back</a></div>
<p class="footer"><a href="https://www.threatatlas.app" target="_blank" rel="noopener">threatatlas.app</a></p>
...
<body>
<a href="https://www.threatatlas.app" class="wm-logo" target="_blank" rel="noopener">${GLOBE_SVG}<span class="wm-logo-text">WorldMonitor MCP</span></a>
<div class="card">
<div class="client-hd">
...
<hr>
<form id="cf" method="POST" action="https://api.threatatlas.app/oauth/authorize">
...
<p class="hint">No key? <a href="https://www.threatatlas.app/pro" target="_blank" rel="noopener">Get one at threatatlas.app/pro &#x2192;</a></p>
<p class="error" id="ke"${errorMsg ? '' : ' style="display:none"'}>${errorMsg ? escapeHtml(errorMsg) : ''}</p>
<button type="submit" id="ab">Authorize</button>
</form>
</div>
<p class="footer"><a href="https://www.threatatlas.app" target="_blank" rel="noopener">threatatlas.app</a> &middot; <a href="https://www.threatatlas.app/pro" target="_blank" rel="noopener">Get an API key &#x2192;</a></p>
...
export default async function handler(req) {
  ...
  if (method === 'POST') {
    ...
    if (origin && origin !== 'https://api.threatatlas.app' && origin !== 'null') {
