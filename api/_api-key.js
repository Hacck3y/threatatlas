...
export function validateApiKey(req, options = {}) {
  ...
  const key = req.headers.get('X-ThreatAtlas-Key') || req.headers.get('X-Api-Key');
  ...
  // Trusted browser origin (threatatlas.app, Vercel previews, localhost dev) — no key needed
